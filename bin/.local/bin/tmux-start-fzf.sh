...
if [[ $# -eq 1 ]]; then
    ...
    selected=$(fd . ~/Repos/ ~/Repos/contrib/ ~/Repos/scratch ~/Repos/learning ~/Library/CloudStorage/OneDrive-Personal/00_Notes/journals --maxdepth 1 --type d 2>/dev/null | fzf)
fi
